...
ConstructClasses["type-12"]={
    NumberX:"448", NumberY:"150", NumberFont:"80", NumberLength:"50", NumberAnchor:"end", NumberFill:"#fff",
    NameX:"460", NameY:"240", NameFont:"52", NameFill:"#fff" , NameAnchor:"end", NameLength:"320", 
    StreetX:"447", StreetY:"200", StreetFont:"30", StreetFill:"#fff", StreetAnchor:"end", StreetLength:"100"};
var color;
...
function colorChange(){
    ...
    color = document.querySelector('[name="colors"]:checked').style.backgroundColor;
    document.getElementById("projectsvg").style.backgroundColor=color;
...
function hiddenInputData(){
    ...
    if(document.querySelector('.eTimer')){
        let timer =document.querySelector('.eTimer').innerText;
        timer = timer.replace(/\n|\r/g, " ");
        text+= " Таймер: " + timer;
    }
